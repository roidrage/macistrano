...
describe ProjectController, "when running a task" do
  before(:each) do
    ...
    @controller.instance_variable_set(:@task_field, @task_field)
    @description_field = stub(:description_field, :stringValue => "Chunky bacon", :setStringValue => "")
    @controller.instance_variable_set(:@description_field, @description_field)
    ...
    @controller.instance_variable_set(:@status_hud_window, @status_window)
    @run_task_dialog = stub(:run_task_dialog, :close => nil)
    @controller.instance_variable_set(:@run_task_dialog, @run_task_dialog)
    @status_window_text = stub(:status_window_text, :setStringValue => nil)
    @controller.instance_variable_set(:@status_hud_window_text, @status_window_text)
